		...
		<div id="content">
			...
			<form method='post' action='saveinvoices.php' name='invoicesform' id='invoicesform'>
				<tr>
					...
					<td>
						<p>
							<input type='date' name='date' placeholder="11/20/2014" required value="<?php echo(isset($date['date'])); ?>"/>
						</p>
					</td>
				</tr>
				<tr>
					...
					<td>
						<p>
							<input type='text' name='firstname' placeholder="Jeffrey" required value="<?php echo(isset($firstname['firstname'])); ?>"/>
						</p>
					</td>
				</tr>
				<tr>
					...
					<td><p>
							<input type='text' name='lastname' placeholder="Riddle" required value="<?php echo(isset($lastname['lastname'])); ?>"/>
						</p></td>
				</tr>
				<tr>
					<td>
					...
					<td><p>
							<input type='text' name='idtires' placeholder="7" required value="<?php echo(isset($idtires['idtires'])); ?>"/>
						</p></td>
				</tr>
				<tr>
					<td>
					...
					<td><p>
							<input type='text' name='quantity' placeholder="2" required value="<?php echo(isset($quantity['quantity'])); ?>"/>
						</p></td>
				</tr>
				<tr>
					<td>
					...
					<td><p>
							<input type="text" name="paid" placeholder="200" required value="<?php echo(isset($paid['paid'])); ?>"/>
