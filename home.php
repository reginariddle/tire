...
?>
<!--
This is the regular user home page 
Author: Regina Hill
Revision Date: 4/21/2015
File Name: home.php
Description: This page is the page used as the home page for regular users
			...
			<?php if(!isset($_SESSION['level']) || $_SESSION['level'] != 'Administrator') :?>
				<form action="index.php?action=login" method="post" id="login">
					<fieldset>
						...
						<input id="password" name="password" type="password" placeholder="regina"
						       value="" required />
