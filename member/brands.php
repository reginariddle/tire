...
<html>
<!--
This is the member brands page 
Author: Regina Hill
Revision Date: 4/21/2015
File Name: brands.php
Description: This page is the page used to show tire brands
		...
		<div id="content">
			...
			<div id="nav">
				<ul>
						...
						<li id="homeBrands"><a id="brands" href="/tire/member/brands.php">Brands</a></li>
					</ul>
			</div>
			</div>
...
<img id="brandslogo" src="../images/brands.gif"/>
	</div>	
