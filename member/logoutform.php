...
<html>
<!--
This is the Member logoutform page 
Author: Regina Hill
Revision Date: 4/21/2015
File Name: logoutform.php
Description: This page is the page used as the logout page for members
		...
		<div id="content">
			...
			<div id="nav">
				<ul>
						...
						<li class="home"><a href="/tire/member/profile.php">Profile</a></li>
						<li class="home"><a href="/tire/member/registration.php">Register?</a></li>
