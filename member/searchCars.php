...
<html>
<!--
This is the Member search Cars page 
Author: Regina Hill
Revision Date: 4/21/2015
File Name: searchCars.php
Description: This page is the page used to search the cars
...
<script src="../src/localization/jquery.mnmenu.js" type="text/javascript"></script>
		...
		<div id="content">
            ...
            <legend>Login</legend>
						...
						<input id="password" name="password" placeholder="regina" type="password"
						       value=""/>
						<input id="logins" class="submit" type="submit" value="login"/>
					</fieldset>
				</form>
			</div>
			<?php else :?>
			...
			<?php if(isset($_SESSION['level']) && $_SESSION['level'] == 'Member') :?>
				...
				<div id="nav">
					...
					<div id="mainMemberHome">
						<h3 id="searchCars">Search for your tire size</h3>
<!--
  ...
  <option idmanufacturer="0" value="0">Select</option>
...
<select name="car" class="select" id="city" disabled>
  <option data-province="test" value="0">Select</option>
