...
?>
<!--
This is the regular user model page 
Author: Regina Hill
Revision Date: 4/21/2015
File Name: model.php
Description: This page is the page used as the model page for regular users
		...
		<div id="content">
			...
			<div id="nav">
				<ul>
					...
					<li id="homePage"><a id="menu-model" href="model.php">Model</a></li>
